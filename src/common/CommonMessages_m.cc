...
Register_Class(DHTreturnSignedCertCall);

DHTreturnSignedCertCall::DHTreturnSignedCertCall(const char *name, int kind) : BaseCallMessage(name,kind)
{
    this->signedCert_var = 0;
}

DHTreturnSignedCertCall::DHTreturnSignedCertCall(const DHTreturnSignedCertCall& other) : BaseCallMessage(other)
{
    copy(other);
}

DHTreturnSignedCertCall::~DHTreturnSignedCertCall()
{
}

DHTreturnSignedCertCall& DHTreturnSignedCertCall::operator=(const DHTreturnSignedCertCall& other)
{
    if (this==&other) return *this;
    BaseCallMessage::operator=(other);
    copy(other);
...
{
    return signedCert_var.c_str();
}

void DHTreturnSignedCertCall::setSignedCert(const char * signedCert)
{
    this->signedCert_var = signedCert;
}

class DHTreturnSignedCertCallDescriptor : public cClassDescriptor
{
  public:
    DHTreturnSignedCertCallDescriptor();
    virtual ~DHTreturnSignedCertCallDescriptor();
...
Register_ClassDescriptor(DHTreturnSignedCertCallDescriptor);

DHTreturnSignedCertCallDescriptor::DHTreturnSignedCertCallDescriptor() : cClassDescriptor("DHTreturnSignedCertCall", "BaseCallMessage")
{
}

DHTreturnSignedCertCallDescriptor::~DHTreturnSignedCertCallDescriptor()
{
}

bool DHTreturnSignedCertCallDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<DHTreturnSignedCertCall *>(obj)!=NULL;
}

const char *DHTreturnSignedCertCallDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}
...
const char *DHTreturnSignedCertCallDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int DHTreturnSignedCertCallDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
std::string DHTreturnSignedCertCallDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool DHTreturnSignedCertCallDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *DHTreturnSignedCertCallDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))

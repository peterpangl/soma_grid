...
Register_Class(DHTRespMsg);

DHTRespMsg::DHTRespMsg(const char *name, int kind) : BaseResponseMessage(name,kind)
{
    take(&(this->msgResponse_var));
    take(&(this->msgCall_var));
}

DHTRespMsg::DHTRespMsg(const DHTRespMsg& other) : BaseResponseMessage(other)
{
    take(&(this->msgResponse_var));
    take(&(this->msgCall_var));
    copy(other);
...
DHTRespMsg::~DHTRespMsg()
{
    drop(&(this->msgResponse_var));
    drop(&(this->msgCall_var));
}

DHTRespMsg& DHTRespMsg::operator=(const DHTRespMsg& other)
{
    if (this==&other) return *this;
    BaseResponseMessage::operator=(other);
    copy(other);
...
void DHTRespMsg::copy(const DHTRespMsg& other)
{
    this->msgResponse_var = other.msgResponse_var;
    this->msgResponse_var.setName(other.msgResponse_var.getName());
    this->msgCall_var = other.msgCall_var;
    this->msgCall_var.setName(other.msgCall_var.getName());
}

void DHTRespMsg::parsimPack(cCommBuffer *b)
{
    BaseResponseMessage::parsimPack(b);
    doPacking(b,this->msgResponse_var);
    doPacking(b,this->msgCall_var);
}

void DHTRespMsg::parsimUnpack(cCommBuffer *b)
{
    BaseResponseMessage::parsimUnpack(b);
    doUnpacking(b,this->msgResponse_var);
    doUnpacking(b,this->msgCall_var);
}

DHTPutResponse& DHTRespMsg::getMsgResponse()
{
    return msgResponse_var;
}

void DHTRespMsg::setMsgResponse(const DHTPutResponse& msgResponse)
{
    this->msgResponse_var = msgResponse;
}

DHTPutCall& DHTRespMsg::getMsgCall()
{
    return msgCall_var;
}

void DHTRespMsg::setMsgCall(const DHTPutCall& msgCall)
{
    this->msgCall_var = msgCall;
}

class DHTRespMsgDescriptor : public cClassDescriptor
{
  public:
    DHTRespMsgDescriptor();
    virtual ~DHTRespMsgDescriptor();
...
Register_ClassDescriptor(DHTRespMsgDescriptor);

DHTRespMsgDescriptor::DHTRespMsgDescriptor() : cClassDescriptor("DHTRespMsg", "BaseResponseMessage")
{
}

DHTRespMsgDescriptor::~DHTRespMsgDescriptor()
{
}

bool DHTRespMsgDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<DHTRespMsg *>(obj)!=NULL;
}

const char *DHTRespMsgDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int DHTRespMsgDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 2+basedesc->getFieldCount(object) : 2;
}

unsigned int DHTRespMsgDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *DHTRespMsgDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int DHTRespMsgDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='m' && strcmp(fieldName, "msgResponse")==0) return base+0;
    if (fieldName[0]=='m' && strcmp(fieldName, "msgCall")==0) return base+1;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *DHTRespMsgDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *DHTRespMsgDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int DHTRespMsgDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    DHTRespMsg *pp = (DHTRespMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string DHTRespMsgDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    DHTRespMsg *pp = (DHTRespMsg *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getMsgResponse(); return out.str();}
        case 1: {std::stringstream out; out << pp->getMsgCall(); return out.str();}
        default: return "";
    }
}

bool DHTRespMsgDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *DHTRespMsgDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *DHTRespMsgDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    DHTRespMsg *pp = (DHTRespMsg *)object; (void)pp;
    switch (field) {
        case 0: return (void *)static_cast<cObject *>(&pp->getMsgResponse()); break;
        case 1: return (void *)static_cast<cObject *>(&pp->getMsgCall()); break;
        default: return NULL;
    }
}
